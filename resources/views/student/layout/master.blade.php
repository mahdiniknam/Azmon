...
<head>
    ...
    <meta name="description" content="پنل دانشجو آزمون ساز آنلاین   ">
    <meta name="keywords" content="پنل دانشجو آزمون ساز آنلاین">
...
<body class="bg-light dark:bg-background-dark text-text-primary-light dark:text-text-primary-dark transition-colors duration-200">
    <div class="flex h-screen overflow-hidden max-w-[1920px] mx-auto">
        <!-- sidebar -->
        @include('student.partial.sidebar')
        <!-- main content -->
        <div class="flex flex-col flex-1 overflow-hidden">
            <!-- header -->
            @include('student.partial.header')
            <!-- component alert -->
