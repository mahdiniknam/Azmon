            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-soft dark:shadow-soft-dark p-8 border border-gray-100 dark:border-gray-700 fade-in">
                    <div class="text-center mb-8">
                        <h2 class="text-2xl font-bold text-dark dark:text-light mb-2">ثبت نام دانش‌آموز</h2>
                        <p class="text-gray-500 dark:text-gray-400">حساب کاربری جدید ایجاد کنید</p>
                    </div>

                    <form class="space-y-5"
                        action="{{ route('student.register.store') }}"
                        method="post">
                        @csrf
                        ...
                        <div class="flex items-center justify-between">
                            <div class="text-sm">
                                <a href="{{ route('student.login') }}" class="font-medium text-primary dark:text-primary-dark hover:underline">
