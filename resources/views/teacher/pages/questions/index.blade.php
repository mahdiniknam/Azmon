...
<main class="flex-1 overflow-y-auto p-6 bg-gray-50 dark:bg-gray-900">
    <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div class="mt-4 md:mt-0">
            <a href="{{ route('teacher.questions.create') }}" class="px-4 py-2 text-sm font-medium rounded-lg bg-primary-600 text-white hover:bg-primary-500 shadow-sm">افزودن سوال جدید</a>
        </div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-start">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 text-sm text-gray-900">{{ \Illuminate\Support\Str::limit($question->question_text, 50) }}</td>
                        ...
                        <td class="px-6 py-4 text-sm">
                            <a href="{{ route('teacher.questions.edit', $question->id) }}" class="text-blue-600 hover:text-blue-900 mx-2">ویرایش</a>
                    ...
                    @empty
                    <tr><td colspan="5" class="px-6 py-4 text-center">موردی یافت نشد.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
