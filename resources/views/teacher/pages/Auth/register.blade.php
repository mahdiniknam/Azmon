            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-soft dark:shadow-soft-dark p-8 border border-gray-100 dark:border-gray-700 fade-in">
                    <div class="text-center mb-8">
                        <h2 class="text-2xl font-bold text-dark dark:text-light mb-2">ثبت‌نام استاد</h2>
                    ...
                    <form class="space-y-5"
                        ...
                        <div class="flex items-center justify-between">
                            <div class="text-sm">
                                <a href="{{ route('teacher.login') }}" class="font-medium text-primary dark:text-primary-dark hover:underline">
