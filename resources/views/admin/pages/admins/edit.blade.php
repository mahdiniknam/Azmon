    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3 space-y-6">
            <div
                ...
                <form action="{{ route('admin.admins.update',$admin) }}" method="post" class="bg-white py-6 space-y-4 dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-700 overflow-hidden border border-gray-200 dark:border-gray-700">
                    {{-- پیام موفقیت --}}
                    @if(session('success'))
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input name="nationalCode" type="tel" id="nationalCode"
                                    value="{{ old('nationalCode', $admin->national_code) }}"
                            ...
                            <div>
                                ...
                                <select name="roles[]"
                                    ...
                                    <option value="{{ $role->id }}"
                                        @if(
                                        collect(old('roles', $admin->roles->pluck('id')->toArray()))
                                        ->contains($role->id)
                                        )
                                        selected
                                        @endif
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-4 @error('status') is-invalid @enderror">
                                    <div class="flex items-center">
                                        <input value="active" id="active" name="status" type="radio" @if ($admin->status == 'active') checked @endif
                                    ...
                                    <div class="flex items-center">
                                        <input value="inactive" id="inactive" name="status" type="radio" @if ($admin->status == 'inactive') checked @endif
                                        class="h-4 w-4 text-primary focus:ring-primary border-gray-300 dark:bg-gray-700 dark:border-gray-600">
