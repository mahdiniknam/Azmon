...
@section('admin-content')
    <main class="flex-1 overflow-y-auto p-6 bg-gray-50 dark:bg-gray-900">
        ...
        <div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">@lang('general.add_new_user')</h2>
                <p class="text-gray-600 dark:text-gray-400">@lang('general.enter_user_info')</p>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="role" id="role"
                            ...
                            <option value="student" @selected(old('role') === 'student')>دانش آموز</option>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4 @error('is_active') is-invalid @enderror">
                            <div class="flex items-center">
                                ...
                                <label for="active" class="ms-2 block text-sm text-gray-700 dark:text-gray-300">
                                    @lang('general.active')
                                </label>
                            </div>
                            ...
                            <div class="flex items-center">
                                <input value="0" id="inactive" name="is_active" type="radio"
                                    ...
                                    class="h-4 w-4 text-primary focus:ring-primary border-gray-300 dark:bg-gray-700 dark:border-gray-600">
                                <label for="inactive" class="ms-2 block text-sm text-gray-700 dark:text-gray-300">
...
@push('scripts')
    ...
    <script>
        $(".select2").select2({
            'placeholder': "@lang('general.enter_country')",
            'allowClear': true,
            'width': '100%'
        });
    </script>
